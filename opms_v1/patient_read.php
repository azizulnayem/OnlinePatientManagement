<?php
	...
	echo "<table border> \n"; 
	echo "<th>Patient_id</th> <th>Email</th> <th>DOB</th> <th>First_Name</th> <th>Middle_Name</th> <th>Last_Name</th> <th>Patient_Number</th> <th>Street</th> <th>City</th> <th>Zip_Code</th> <th>State</th> <th>Doctor_id</th> <th>Delete</th> <th>Update</th> \n";
	...
	echo "</table> \n";
	echo "<p><a href=patient_input.php>ADD A NEW PATIENT</a>";
?>